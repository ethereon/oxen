...
class AppStateManager {
    ...
    setTasks(tasks) {
        ...
        if (newState.tasks.length === 0) {
            ...
            const selectedTask = newState.tasks.find(task => task.id == this.lastKnownState.selectedTask.id);
...
/* unused harmony export AppStateManager */

const appStateManager = new AppStateManager();
/* harmony export (immutable) */ __webpack_exports__["a"] = appStateManager;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__app_view__ = __webpack_require__(28);



__WEBPACK_IMPORTED_MODULE_0_react_dom__["render"](__WEBPACK_IMPORTED_MODULE_1_react__["createElement"](__WEBPACK_IMPORTED_MODULE_2__app_view__["a" /* AppView */]), document.getElementById('app'));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__task_list_view__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__app_state__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__task_view__ = __webpack_require__(30);




class AppView extends __WEBPACK_IMPORTED_MODULE_0_react__["Component"] {
    componentDidMount() {
        __WEBPACK_IMPORTED_MODULE_2__app_state__["a" /* appStateManager */].addSubscriber(this);
    }
    componentWillUnmount() {
        __WEBPACK_IMPORTED_MODULE_2__app_state__["a" /* appStateManager */].removeSubscriber(this);
    }
    onNewState(state) {
        this.setState(state);
    }
    render() {
        if (this.state == null) {
            return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("p", null, "Loading...");
        }
        return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_0_react__["Fragment"], null,
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_1__task_list_view__["a" /* TaskListView */], { tasks: this.state.tasks, selectedTask: this.state.selectedTask }),
            this.state.selectedTask && __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_3__task_view__["a" /* TaskView */], { task: this.state.selectedTask })));
    }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__app_state__ = __webpack_require__(14);


class TaskListViewItem extends __WEBPACK_IMPORTED_MODULE_0_react__["PureComponent"] {
    activateTask() {
        __WEBPACK_IMPORTED_MODULE_1__app_state__["a" /* appStateManager */].selectTask(this.props.task);
    }
    render() {
        return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("button", { className: "task-item", onClick: () => this.activateTask() },
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("span", { className: `status-indicator status-${this.props.task.status}` }),
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("span", { className: "title" }, this.props.task.name)));
    }
}
class TaskListView extends __WEBPACK_IMPORTED_MODULE_0_react__["PureComponent"] {
    render() {
        return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { id: "task-list" }, this.props.tasks.map(task => (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"](TaskListViewItem, { key: task.id, task: task, isSelected: false })))));
    }
}
/* harmony export (immutable) */ __webpack_exports__["a"] = TaskListView;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ansi_up__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ansi_up___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_ansi_up__);


class TaskView extends __WEBPACK_IMPORTED_MODULE_0_react__["Component"] {
    componentDidMount() {
        this.connect();
    }
    componentWillUnmount() {
    ...
    connect() {
        ...
        webSocket.onopen = () => {
            ...
            this.ansiMarkup = new __WEBPACK_IMPORTED_MODULE_1_ansi_up___default.a();
        };
        webSocket.onmessage = msg => {
            this.taskOutputContainer.insertAdjacentHTML('beforeend', this.ansiMarkup.ansi_to_html(msg.data));
    ...
    render() {
        return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "task-view" },
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "task-status" },
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("span", { className: "info" }, this.task.name),
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("span", { className: "status" },
                    " \u2014 ",
                    this.task.status)),
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("pre", { key: this.task.id, ref: elem => (this.taskOutputContainer = elem), className: 'task-output' + (this.isConnected ? '' : ' task-output-disconnected') }),
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "task-actions" },
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("button", { onClick: () => (this.isConnected ? this.disconnect() : this.connect()) }, this.isConnected ? 'Disconnect' : 'Connect'),
                this.task.actions.map(action => (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("button", { key: action, onClick: () => this.performAction(action) }, action))))));
    }
}
